...
public:
  ...
  double fitStep4Public(double *T,const int32_t T_num,Matrix &R,Matrix &t,const std::vector<int32_t> &active);
  bool checkWorkable();
  
private:
  
  // iterative fitting
  double fitIterate(double *T,const int32_t T_num,Matrix &R,Matrix &t,const std::vector<int32_t> &active);
